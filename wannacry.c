...
int WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd)
{
  ...
  while (iVar1 != 0
    ...
    iVar1 = iVar1 + -1;
    *(undefined4 *)weird_url_cpy2 = *(undefined4 *)werid_url_cp;
    werid_url_cp = werid_url_cp + 4;
    weird_url_cpy2 = weird_url_cpy2 + 4;
  }
  *weird_url_cpy2 = *werid_url_cp;
  local_17 = 0;
  InternetOpenA((LPCSTR)0x0,1,(LPCSTR)0x0,(LPCSTR)0x0,0);
  internet_open_url_HANDLE = InternetOpenUrlA(hInternet,local_50,(LPCSTR)0x0,0,2214592512,0);
                    /* if it fails... */
